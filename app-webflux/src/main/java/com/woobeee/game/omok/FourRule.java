 ...
 * 3..7(흑 {3,4,5,6}, 빈칸7)은 채우면 정확히 5지만, 창 4..8(흑 {4,5,6,8}, 빈칸7)은 채우면
 * 3..8 이 되어 6(장목)이다 — 모양만 보면 둘 다 통과하지만 후자는 사가 아니다. 그래서 각 창은
 * 후보 빈칸에 흑을 임시로 놓고 {@link LineScanner#runLength} 로 실제 결과 길이가 5인지 확인한
 * 뒤 반드시 원상복구한다.
 */
